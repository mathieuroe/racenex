...
Usage:
    python3 itra_importer.py [--limit N] [--countries DE,FR,IT,...] [--months N]

Output:
    db/imports/itra_<timestamp>.sql — INSERT statements with
    ON CONFLICT (slug) DO NOTHING. Nothing is executed against any
    database; review the file before running it yourself.
"""
